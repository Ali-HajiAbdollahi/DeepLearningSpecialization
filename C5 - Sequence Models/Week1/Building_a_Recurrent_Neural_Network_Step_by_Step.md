...
def lstm_cell_backward(da_next, dc_next, cache):
    ...
    dit = dc_next * cct + ot * (1 - np.tanh(c_next)**2) * cct * da_next * (1 - it)
...
```
    ...
    gradients["dxt"][1][2] = -1.8672314277472564
    gradients["dxt"].shape = (3, 10)
    gradients["da_prev"][2][3] = 0.2457587281659879
    gradients["da_prev"].shape = (5, 10)
    gradients["dc_prev"][2][3] = 0.7975220387970015
    gradients["dc_prev"].shape = (5, 10)
    gradients["dWf"][3][1] = -3.777816053700852
    gradients["dWf"].shape = (5, 8)
    gradients["dWi"][1][2] = 4.0125997616135916
    gradients["dWi"].shape = (5, 8)
    gradients["dWc"][3][1] = 2.548798730065208
    gradients["dWc"].shape = (5, 8)
    gradients["dWo"][1][2] = 0.3313115952892109
    gradients["dWo"].shape = (5, 8)
    gradients["dbf"][4] = [-2.09422168]
    gradients["dbf"].shape = (5, 1)
    gradients["dbi"][4] = [-2.58494852]
    gradients["dbi"].shape = (5, 1)
    gradients["dbc"][4] = [2.76717119]
...
```
    ...
    gradients["dx"][1][2] = [ 0.3178851   0.26770895 -0.58781916 -0.37493935]
    gradients["dx"].shape = (3, 10, 4)
    gradients["da0"][2][3] = 0.15922990031883344
    gradients["da0"].shape = (5, 10)
    gradients["dWf"][3][1] = -0.05806321532743108
    gradients["dWf"].shape = (5, 8)
    gradients["dWi"][1][2] = 0.0957356084628106
    gradients["dWi"].shape = (5, 8)
    gradients["dWc"][3][1] = -0.09130037076522961
    gradients["dWc"].shape = (5, 8)
    gradients["dWo"][1][2] = 0.04843891314443014
    gradients["dWo"].shape = (5, 8)
    gradients["dbf"][4] = [-0.23299803]
    gradients["dbf"].shape = (5, 1)
    gradients["dbi"][4] = [-1.56230448]
    gradients["dbi"].shape = (5, 1)
    gradients["dbc"][4] = [-0.46019743]
    gradients["dbc"].shape = (5, 1)
